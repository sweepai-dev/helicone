...
const AuthPage = (props: AuthPageProps) => {
  ...
  return (
    <div className="flex min-h-full flex-1 bg-white h-screen">
      <div className="flex flex-1 flex-col justify-center items-center text-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
        <div className="mx-auto w-full max-w-sm lg:w-96">
          <div>
            <h2 className="mt-8 text-3xl font-semibold leading-9 tracking-tight text-gray-900">
              Create an account
            </h2>
