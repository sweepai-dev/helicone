...
export const Chat = (props: ChatProps) => {
  ...
  return (
    <div className="w-full flex flex-col text-left space-y-1 text-xs">
      ...
      <div className="flex flex-col text-xs w-full border border-gray-300 rounded-md overflow-auto divide-y divide-gray-200">
            ...
            <div key={index} className="">
              <div
                className={clsx(
                  ...
                  "items-start px-4 py-4 text-left grid grid-cols-10 gap-2"
                )}
              >
